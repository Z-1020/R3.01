...
bouton.forEach(bouton => {
    bouton.addEventListener("click", ()=>{
        ...
        if(choixOrdi == bouton.value){
            ...
            resultat.className = 'alert alert-warning display-6 text-center'
        }
            ...
            resultat.className = 'alert alert-success display-6 text-center'
        }
            ...
            resultat.className = 'alert alert-danger display-6 text-center'
        }
    ...
    reset.addEventListener('click', ()=>{
        ...
        defaite.textContent = "Nombre de défaite: " + nbDefaite
        egalite.textContent ="Nombre d'égalité: "+ nbEgalite
        resultat.className = "display-6 text-center"
        texte3.textContent = "Résultat"
    })
